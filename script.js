...
function renderTable() {
    ...
    if (filtered.length === 0) {
        tbody.innerHTML = `<tr><td colspan="5" style="text-align:center; padding: 1.5rem;">No records found.</td></tr>`;
        return;
    }
...
function filterStudentHistory() {
    ...
    if (filteredLogs.length === 0) {
        tbody.innerHTML = `<tr><td colspan="4" style="text-align:center; padding: 1.5rem;">No records found for selected date range.</td></tr>`;
        return;
    }
